...
export default async function Home() {
    const [robots, properties] = await Promise.all([
        getRobots(),
        getProperties(),
    ]);
        ...
        <main className="mx-auto w-full max-w-4xl flex-1 px-6 py-12">
            <header className="mb-8">
                ...
                <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
                    Robot online/offline status. The status pipeline is not
                    implemented yet — this is your starting point.
                </p>
            </header>
                        ...
                        return (
                            ...
                            >
                                ...
                                <ul className="mt-3 text-xs text-zinc-500 dark:text-zinc-400">
                                    <li>
                                        robot · cellular router · payload RPi
                                        (+sensors) · dog house RPi
                                    </li>
                                </ul>
                            </article>
                        );
            ...
            <p className="mt-10 text-xs text-zinc-400 dark:text-zinc-500">
                ...
                <code>src/lib/normalize.ts</code>, and{" "}
                <code>src/lib/status.ts</code>, persist via{" "}
                <code>src/lib/db.ts</code>, then surface it here or at{" "}
